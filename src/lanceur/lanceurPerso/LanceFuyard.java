...
import client.strategie.StratFuyard;
 ...
 */
public class LanceFuyard {
	
	private static String usage = "USAGE : java " + LanceFuyard.class.getName() + " [ port [ ipArene ] ]";
	...
	public static void main(String[] args) {
		...
		try {
			...
			new StratFuyard(ipArene, port, ipConsole, nom, groupe, caracts, nbTours, position, logger, type);
