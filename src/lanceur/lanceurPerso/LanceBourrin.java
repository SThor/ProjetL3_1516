...
import client.strategie.StratBourrin;
 ...
 */
public class LanceBourrin {
	
	private static String usage = "USAGE : java " + LanceBourrin.class.getName() + " [ port [ ipArene ] ]";
	...
	public static void main(String[] args) {
		...
		try {
			...
			new StratBourrin(ipArene, port, ipConsole, nom, groupe, caracts, nbTours, position, logger, type);
